    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-dark" style="  margin-top: 40px;">
          ...
          <form id="quickForm" action="{{url('updateData/'.$user->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                {{-- <div class="col-md-12"> --}}
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" value="{{$user->phone}}" name="phone" class="form-control" id="exampleInputEmail1" placeholder="Enter phone">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                    <label for="exampleInputPassword1" class="text">Role</label>
                                    <select class="form-control select2" value="{{$user->role}}" name="role">
