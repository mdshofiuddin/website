...
<header class="py-5 bg-image-full" style="background-image: url('{{asset('assets/images/9.jpg')}}')">
    <div class="text-center my-5">
        <img class="img-fluid mb-4" style="height: 150px;width: 150px; border-radius:50%;" src="{{asset('assets/images/9.jpg')}}" alt="..." />
